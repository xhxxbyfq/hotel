...
/*--------------------------------------- 团队结账 end------------------------------------------------------------------*/		
	...
	public ModelAndView toshiftpersonage(String id,String stayregisterdetailsId){
		int i1 = stayregisterdetailsId.indexOf(".");
//		System.out.println(i1);
		String substring = stayregisterdetailsId.substring(0, i1);
//		System.out.println(substring);
		...
		double zongFeiYong=0;
		String txtname="";
		List<StayRegisterPo> listDeposit=stayRegisterService.selectDepositJinJianBan(Integer.parseInt(id));
		List<StayRegisterPo> listXiaoFei=stayRegisterService.selectConsumptionJinJianBan(Integer.parseInt(id));
		StayRegisterPo list=stayRegisterService.selectInformationXiangQingBan(Integer.parseInt(id));
		for (int i = 0; i < listDeposit.size(); i++) {
			yaJin+=listDeposit.get(i).getDeposit();
		}
	...
	public ModelAndView toshiftteam(String id,String stayregisterdetailsId){
		int i1 = stayregisterdetailsId.indexOf(".");
//		System.out.println(i1);
		String substring = stayregisterdetailsId.substring(0, i1);
//		System.out.println(substring);
